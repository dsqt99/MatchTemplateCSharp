...
namespace Matching
{
    ...
    public class MatchingPyramidNCC
    {
        ...
        // Comparation
        private List<DataPoint> Comparation(Mat src_refimg, Mat src_tplimg, int level, int maxlevel, double threshold,
                                        List<DataPoint> ANS, List<List<DataRotation>> listSamples)
        {
            ...
            int Wt = refimg.Width; int Ht = refimg.Height;
        ...
        public List<DataPoint> Matching(Mat src_refimg, Mat src_tplimg, int maxlevel)
        {
            ...
            {
                // Time levels
                ANS = Comparation(src_refimg, src_tplimg, level, maxlevel, threshScore, ANS, listSamples);
            }
            return ANS;
        }

        public Mat DrawBoundaryResult(Mat refimg, Mat tplimg, List<DataPoint> RES, double threshscore)
        {
